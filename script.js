...
// Контракт и адрес
const tokenAddress = "0x173799E94Bf1d95Da829B7F7099cC13C583f3E27"; // Адрес вашего токена
const tokenABI = [ /* Вставьте ABI вашего контракта сюда */ ]; // Добавьте ABI контракта
